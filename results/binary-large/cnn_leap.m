...
net.layers{end+1} = struct('type', 'conv', ...
                           'filters', f*randn(4,4,1,30, 'single'), ...
...
net.layers{end+1} = struct('type', 'pool', ...
                           ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'conv', ...
                           'filters', f*randn(6,5,30,100, 'single'),...
...
net.layers{end+1} = struct('type', 'pool', ...
                           ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'conv', ...
                           'filters', f*randn(9,7,100,200, 'single'),...
...
net.layers{end+1} = struct('type', 'pool', ...
                           ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'conv', ...
                           'filters', f*randn(10,5,200,300, 'single'),...
                           'biases', zeros(1,300,'single'), ...
                           'stride', 1, ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'relu') ;
net.layers{end+1} = struct('type', 'conv', ...
                           'filters', f*randn(1,1,300,opts.train.outputClasses, 'single'),...
